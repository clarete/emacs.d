...
**** Replace asterisks and dashes with nice looking UTF-8 bullets in unordered lists
...
#+begin_src elisp
  (custom-set-faces
   '(org-level-1 ((t (:inherit outline-1 :height 1.300 :weight extra-bold))))
   '(org-level-2 ((t (:inherit outline-2 :height 1.250 :weight extra-bold))))
   '(org-level-3 ((t (:inherit outline-3 :height 1.125 :weight bold))))
   '(org-level-4 ((t (:inherit outline-4 :height 1.000 :weight bold))))
   '(org-level-5 ((t (:inherit outline-5 :height 0.875 :weight semi-bold)))))
#+end_src

**** Change symbol and font used for the heading stars

#+begin_src elisp
  (font-lock-add-keywords 'org-mode '(("^\\(*+\\)" . font-lock-doc-face)))
  (font-lock-add-keywords
   'org-mode '(("^\\(*+\\)"
                (0 (prog1 ()
